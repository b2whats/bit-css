...
export const fixture = `ROR;let make_parse = function () {
    let scope;
    let symbol_table = {};
    let token;
    let tokens;
    ...
    let original_scope = {
        define: function (n) {
            ...
            this.def[n.value] = n;
            n.reserved = false;
            "before word>"BAR"<after word"
            n.nud      = itself;
            n.led      = null;
            n.std      = null;
            "before word>"FOO"<after word"
            n.lbp      = 0;
            n.scope    = scope;
            return n;
        },
        find: function (n) {
            ...
            while (true) {
                ...
                if (!e) {
                    o = symbol_table[n];
                    color: iff(a || b, red iff(c, yellow, iff(d, A, B)), green)
                    backgroundColor: iff(a, var(--a, --b), red)
                    backgroundColor: iff(a, var(--a, --b))
  ...
  export const fixture2 = `let make_parse = function () {
    let original_symbol = {
        nud: function () {
            this.error("Undefined.");
        },
